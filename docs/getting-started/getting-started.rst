...
Download the latest **tcframe** `here <https://github.com/tcframe/tcframe/releases/download/v0.7.0/tcframe_0.7.0.zip>`_. Extract the zip file somewhere on your system; for example, ``~/tcframe``. We will call this directory "**tcframe** home". Confirm that you extracted it correctly by verifying that the directory ``include`` exists directly inside **tcframe** home.
