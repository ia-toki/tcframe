...
TEST(DeprecatedBaseGeneratorTest, DefaultOptions) {
...
TEST(DeprecatedBaseGeneratorTest, MyOptions) {
...
TEST(DeprecatedBaseGeneratorTest, CommandLineOptions) {
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithSubtasksAndTestGroups) {
...
TEST(DeprecatedBaseGeneratorTest, FailedGenerationWithSubtasksAndTestGroups) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithSubtasksAndTestGroupsAndMultipleTestCasesPerFile) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, FailedGenerationWithSubtasksAndTestGroupsAndMultipleTestCasesPerFile) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithoutSubtasksAndWithoutTestGroups) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, FailedGenerationWithoutSubtasksAndWithoutTestGroups) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithoutSubtasksAndWithoutTestGroupsAndWithMultipleTestCasesPerFile) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, FailedGenerationWithoutSubtasksAndWithoutTestGroupsAndWithMultipleTestCasesPerFile) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithFailedExecution) {
    FakeGeneratorLogger logger;
...
TEST(DeprecatedBaseGeneratorTest, GenerationWithLoopVariableInsideLambda) {
    FakeGeneratorLogger logger;
